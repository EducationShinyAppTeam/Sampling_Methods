    ...
    tabItems(
      ...
      tabItem(tabName = "overview",
              ...
              fluidPage(
                ...
                br(),br(),br(),
                h3(strong("About:")),
                h4("Explore four of the most commonly used sampling methods: Simple Random Sampling, Stratified Sampling, Cluster Sampling, and Systematic Sampling.
                   If you would like a basic refresher on Sampling, please refer to the", actionLink("prerequisites", "Prerequisites"), "tab. 
                   If not, read the instructions and press the 'Go' button to proceed."),
                br(),
                h3(strong("Instructions: ")),
                h4(tags$li("On the Explore page, you will be simulating random samples of counties in the United States.")),
                h4(tags$li("On each tab, there will be a different sampling method for you to delve into so you can see the processes involved within each method")),
                div(style = "text-align: center",
                    bsButton("go","G O !",icon("bolt"),style = "danger",size = "large",class = "circle grow")),
                br(),
                ...
                navbarPage(title = strong("Sampling Methods: "), id = "navMain",
                                    ...
                                    fluidPage(
                                      ...
                                      sidebarLayout(
                                        sidebarPanel(
                                          ...
                                          br(), br(),
                                          p(strong(" Numbers Generated for First Sample (First 50):")),
                                          textOutput("randNumbs"),
                                          br(),
                                          p(strong("Corresponding Counties in First Sample (First 50):")),
                                          textOutput("first50Counties")
                                        ),
                                        mainPanel(
                                          plotOutput("myMap") %>% withSpinner(color = "red"),
                                    ...
                                    fluidPage(
                                      fluidRow(
                                        wellPanel(h4("In", strong("stratified random sampling"), ", the population is first divided into non-overlapping groups, 
                                                     ...
                                                     taken within each strata, and then these samples are put together to achieve your stratified random sample. 
                                      ...
                                      sidebarLayout(
                                        sidebarPanel(
                                          selectInput("strataVar", "Strata Variable", choices = c("Geographic Region", "Pop. Per Square Kilometer")),
                                          bsButton("generate2", "Generate Strata", icon("sync-alt"), type = "action", style = "primary"),
                                          br(), br(),
                                          tags$style(HTML(".js-irs-2 .irs-single, .js-irs-2 .irs-bar-edge, .js-irs-2 .irs-bar {background: red}")),
                                          sliderInput("srsSize2", "Select how large you would like your sample size to be:", min = 50, max = 2000, value = 1000, step = 25),
                                          bsButton("generate3", "Generate Random Sample", icon("sync-alt"), type = "action", style = "success"),
                                          br(), br(),
                                      ...
                                      #                  fluidRow(
                                      #                    column(1, bsButton("prev1", "<<Previous", style = "danger", size = "medium")),
                                    ...
                                    fluidPage(
                                      ...
                                      sidebarLayout(
                                        sidebarPanel(
                                          ...
                                          bsButton("generate4", "Generate Clusters", icon("sync-alt"), type = "action", style = "primary"),
                                          br(), br(),
                                          tags$style(HTML(".js-irs-3 .irs-single, .js-irs-3 .irs-bar-edge, .js-irs-3 .irs-bar {background: red}")),
                                          sliderInput("srsSize3", "Select how large you would like your sample size of clusters to be:", min = 5, max = 25, value = 15, step = 1),
                                          p(strong("Now, generate your sample of clusters: ")),
                                          bsButton("generate5", "Generate Random Sample", icon("sync-alt"), type = "action", style = "success"),
                                          br(), br(),
                                          p(strong("States (and respective counties) included in Sample:")),
                                          textOutput("sampleStates")
                                        ),
                                        mainPanel(
                                          useShinyjs(),
                                          plotOutput("myMap3") %>% withSpinner(color = "red"),
                           ...
                           tabPanel("Systematic", value = "d",
                                    fluidPage(
                                      ...
                                      sidebarLayout(
                                        sidebarPanel(
                                          p(strong("Based on the ordering system described above, please randomly generate a number between 1 and 3108 to get a starting
                                                   point for your systematic sample:")),
                                          bsButton("startPoint", "Select Starting County", icon("random"), type = "action", style = "primary"),
                                          br(), br(),
                                          ...
                                          sliderInput("srsSize4", "Please select how large you would like your sample size to be:", 
                                                      min = 50, max = 200, value = 125, step = 1),
                                          bsButton("generate6", "Generate Random Sample", icon("sync-alt"), type = "action", style = "success"),
                                          br(), br(),
                                          p(strong("Interval Size (Total number of elements in population divided by sample size rounded down to the nearest integer): ")),
